...
function UspBadge({ icon, label }: { icon: string; label: string }) {
  return (
    <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-xs text-gray-600 dark:text-gray-300 print:bg-gray-100 print:border-gray-300 print:text-gray-700">
...
function BulletList({ items, color = 'text-green-600 dark:text-green-500' }: {
    ...
    <ul className="space-y-2">
      {items.map((it, i) => (
        <li key={i} className="flex gap-3 text-sm">
          ...
          <span>
            <strong className="text-gray-800 dark:text-gray-100 print:text-gray-900">{it.head}</strong>
            {it.body && <span className="text-gray-500 dark:text-gray-400 print:text-gray-600"> — {it.body}</span>}
          </span>
        </li>
      ))}
    </ul>
  ...
  return (
    <figure className="space-y-3 print:break-inside-avoid">
      <div className="rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 print:border-gray-300">
        ...
        />
        <div className="hidden h-40 items-center justify-center text-gray-500 dark:text-gray-600 text-sm flex-col gap-1" aria-hidden>
      ...
      <figcaption className="space-y-0.5">
        <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 print:text-gray-500 uppercase tracking-wide">{caption}</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 print:text-gray-600 leading-relaxed">{description}</p>
      </figcaption>
    </figure>
  )
}
...
function InlineImage({ src, alt, caption, side = 'left', children }: {
  ...
  const img = (
    <figure className="w-1/4 shrink-0 space-y-1.5">
      <div className="rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 print:border-gray-300">
        <img
          src={src} alt={alt}
          className="w-full object-cover"
          onError={e => {
        ...
        />
        <div className="hidden h-24 items-center justify-center text-gray-500 dark:text-gray-600 text-xs flex-col gap-1" aria-hidden>
    ...
    <div className="max-w-4xl mx-auto space-y-2">
      ...
      <div className="flex items-center justify-between print:hidden mb-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-gray-500 dark:text-gray-600 font-mono">Ella_EMS_Doc3 · Entwurf</span>
      ...
      {/* Dokument-Body */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 print:p-0 print:bg-white print:border-0 space-y-10">
        ...
        <div className="text-center space-y-3 pb-6 border-b border-gray-200 dark:border-gray-800 print:border-gray-300">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 print:text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={h} className="flex gap-2">
                    ...
                    <span className="text-gray-500 dark:text-gray-400 print:text-gray-600">
                      <strong className="text-gray-700 dark:text-gray-200 print:text-gray-800">{h}</strong> — {b}
                    </span>
                  </li>
                ))}
              </ul>
        ...
        <section className="space-y-4 print:break-inside-avoid">
          ...
          <BulletList color="text-green-600 dark:text-green-500" items={[
        ...
        <section className="space-y-5">
          ...
          <BulletList color="text-amber-600 dark:text-amber-400" items={[
        ...
        <section className="space-y-5">
          ...
          <BulletList color="text-purple-600 dark:text-purple-400" items={[
